      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/90 dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl p-8 shadow-2xl transition-colors duration-300">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Welcome to Collab AI</h1>
            <p className="text-slate-500 dark:text-slate-400 text-center">Sign in or create an account to manage your team tasks and performance.</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">Select your role</label>
