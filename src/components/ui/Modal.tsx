...
export function Modal({ isOpen, onClose, title, children, className }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className={cn(
        "relative w-full max-w-lg rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200",
        className
      )}>
